  ...
  return (
    <div className="flex w-full bg-[#404040] mx-auto py-10 justify-center items-center">
      <div className="mb-8 w-full max-w-[1250px] px-4">
        <h2 className="text-4xl font-bold text-amber-50 mb-6">Appetizer</h2>
            ...
            return (
              ...
              >
                <div className="relative mt-2 mx-2">
                  ...
                  <div className="absolute z-50 top-35 right-3 h-10 w-10 bg-amber-50 text-red-500 rounded-full hover:bg-amber-100 flex items-center justify-center text-lg">
                    <FoodDialog
                      foodName={""}
                      image={""}
                      ingredients={""}
