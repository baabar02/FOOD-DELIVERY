...
<div className="mt-[60px] w-full h-[92px] bg-[#EF4444] text-amber-50 flex items-center gap-10 overflow-hidden hover:animate-none">
        <p className="text-[36px] font-bold animate-slide">Fresh Fast Delivered</p>
        <p className="text-[36px] font-bold animate-slide">Fresh Fast Delivered</p>
        <p className="text-[36px] font-bold animate-slide">Fresh Fast Delivered</p>
        <p className="text-[36px] font-bold animate-slide">Fresh Fast Delivered</p>
        <p className="text-[36px] font-bold animate-slide">Fresh Fast Delivered</p>
...
<h2 className="flex items-center">
  ...
  />
    ...
    <h1 className="flex gap-2 items-center text-[14px] text-[#71717A]">Copy right 2025 <Copyright className="w-[14px] h-[14px]"/> NOMNOM LLC</h1>
        <h1 className="flex gap-2 items-center text-[14px] text-[#71717A]">Privicy policy</h1>
        <h1 className="flex gap-2 items-center text-[14px] text-[#71717A]">Terms and condition</h1>
        <h1 className="flex gap-2 items-center text-[14px] text-[#71717A]">Cookie policy</h1>
        </div>
